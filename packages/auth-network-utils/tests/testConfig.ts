export const NODE_DETAILS = {
  ...
  torusNodeRSSEndpoints: [
    'https://node-1.dev-node.web3auth.io/rss',
    'https://node-2.dev-node.web3auth.io/rss',
    'https://node-3.dev-node.web3auth.io/rss',
    'https://node-4.dev-node.web3auth.io/rss',
    'https://node-5.dev-node.web3auth.io/rss'
  ],
  torusNodeTSSEndpoints: [
    'https://node-1.dev-node.web3auth.io/tss',
    'https://node-2.dev-node.web3auth.io/tss',
    'https://node-3.dev-node.web3auth.io/tss',
    'https://node-4.dev-node.web3auth.io/tss',
    'https://node-5.dev-node.web3auth.io/tss'
  ],
  torusNodePub: [
    {

...
const JsonStringify = $importDefault($JsonStringify);
import { SomeError } from "./errors.mjs";
 ...
 */
export function keccak256AndHexify(buffer) {
 ...
 */
export function thresholdSame(arr, t) {
    const hashMap = {};
 ...
 */
export function kCombinations(s, k) {
    let set = s;
 ...
 */
export const getProxyCoordinatorNodeIndex = (indexes, verifier, verifierId) => {
 ...
 */
export async function retryPromiseWithBackoff(executionPromise, maxRetries) {
 ...
 */
export async function Some(promises, callbackFn) {
 ...
 */
export function convertKeys(obj, convertFunc) {
 ...
 * @returns The object with the converted keys.
 */
export const toCamelCaseKeys = (obj) => convertKeys(obj, toCamel);
/**
 ...
 * @returns The object with the converted keys.
 */
export const toSnakeCaseKeys = (obj) => convertKeys(obj, toSnake);

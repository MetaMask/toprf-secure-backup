 ...
 * @param authConnectionId - The verifier name to be used for the commitment request.
 ...
 * @param params.authConnectionId - The verifier to be used for the commitment request

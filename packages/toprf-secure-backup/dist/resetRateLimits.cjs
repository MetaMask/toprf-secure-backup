...
exports.resetRateLimits = exports.validateThresholdResetRateLimitResponses = exports.sendResetRateLimitRequest = exports.createResetRateLimitRequestParams = void 0;
 ...
 */
const sendResetRateLimitRequest = async (endpoint, params) => {
    ...
    return (0, utils_1.postJRPCRequest)(endpoint, resetRateLimitJRPCRequest);
};
exports.sendResetRateLimitRequest = sendResetRateLimitRequest;
/**
...
const validateThresholdResetRateLimitResponses = async (resultArr, threshold) => {
    ...
    if (completedRequests.length < threshold) {
        throw auth_network_utils_1.TOPRFError.invalidAuthenticateResults(`invalid reset rate limit results, expected ${threshold} but got ${completedRequests.length}`);
    }
...
const resetRateLimits = async (params) => {
    ...
    const promiseArr = authTokens.map(async (authToken) => {
        ...
        return (0, exports.sendResetRateLimitRequest)(endpoint, requestParams);
    });

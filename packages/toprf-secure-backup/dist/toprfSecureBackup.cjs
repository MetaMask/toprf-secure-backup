...
const commitRequest_1 = require("./commitRequest.cjs");
...
class ToprfSecureBackup {
    ...
    async authenticate(params) {
        ...
        const commitmentResults = await (0, commitRequest_1.commitIdToken)({
        ...
        })), constants_1.EXISTING_USER_AUTHENTICATION_THRESHOLD);
        return {
    ...
    createLocalEncKey(params) {
        ...
        const passwordBytes = (0, utils_1.toBytes)(password);
        const hashedInput = (0, sha256_1.sha256)(passwordBytes);
        const oprfKey = (0, oprf_1.generateRandomScalar)();
        const seed = oprf_1.OPRF.localEval(oprfKey, hashedInput);
        const authKeyPair = (0, keyDerivation_1.deriveAuthenticationKeyPair)(seed);
        const encKey = (0, keyDerivation_1.deriveEncryptionKey)(seed);
        return {
            oprfKey,
            seed,
            authKeyPair: {
    ...
    async createEncKey(params) {
        ...
        await (0, storeSharesRequest_1.storeKeyShares)({
            nodeEndpointsMap,
            verifier,
            verifierId,
    ...
    async recoverEncKey(params) {
        ...
        const { nodeEndpointsMap } = await __classPrivateFieldGet(this, _ToprfSecureBackup_instances, "m", _ToprfSecureBackup_getNodeDetails).call(this);
        const passwordBytes = (0, utils_1.toBytes)(password);
        const userPasswordHash = (0, sha256_1.sha256)(passwordBytes);
...
async function _ToprfSecureBackup_createMetadataStore() {
    ...
    const metadataStore = new metadata_1.MetadataStore({

...
- Add optional `keyDeriver` parameter to `ToprfSecureBackup` constructor ([#105](https://github.com/MetaMask/toprf-secure-backup/pull/105))

### Changed

- **Breaking**: `createLocalKey` is now an asynchronous function that returns a Promise.([#105](https://github.com/MetaMask/toprf-secure-backup/pull/105))

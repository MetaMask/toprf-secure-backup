...
- Add `deleteSecretDataItem` and `batchDeleteSecretDataItems` methods to soft delete secret data items. ([#158](https://github.com/MetaMask/toprf-secure-backup/pull/158))

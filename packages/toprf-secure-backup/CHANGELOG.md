...
- Replaced `couldNotFetchPassword` error with `maxKeyChainLengthExceeded` in `recoverPwEncKey` function.
...
[Unreleased]: https://github.com/MetaMask/toprf-secure-backup/compare/@metamask/toprf-secure-backup@0.6.0...HEAD

...
Examples:
  ...
  yarn workspace @metamask/toprf-secure-backup run since-latest-release
  yarn workspace @metamask/toprf-secure-backup run since-latest-release diff
  yarn workspace @metamask/toprf-secure-backup run since-latest-release log -p
  yarn workspace @metamask/toprf-secure-backup run since-latest-release --include-head -- log -p
